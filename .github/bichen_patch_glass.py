...
panel_start = s.index('@OptIn(ExperimentalMaterial3Api::class)\n@Composable\nprivate fun RefPanel(')
tabs_start = s.index('@Composable\nprivate fun RefPanelTabs', panel_start)

new_panel = '''@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun RefPanel(
...
s = s[:panel_start] + new_panel + s[tabs_start:]

group_start = s.index('@Composable\nprivate fun RefGroupCard')
nodegrid_start = s.index('@Composable\nprivate fun RefNodeGrid', group_start)
provider_start = s.index('@Composable\nprivate fun RefProviderRow', nodegrid_start)
...
s = s[:group_start] + new_group + s[provider_start:]
p.write_text(s)
