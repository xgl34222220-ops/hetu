...
public final class MihomoNative {
 ...
 private static synchronized void load()throws IOException{if(loaded)return;try{System.loadLibrary("bichen_core");loaded=true;}catch(UnsatisfiedLinkError e){throw new IOException("本安装包缺少适配当前 CPU 的 Mihomo 内核",e);}}
