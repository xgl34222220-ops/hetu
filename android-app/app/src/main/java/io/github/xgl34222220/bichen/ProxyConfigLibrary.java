...
final class ProxyConfigLibrary {
    ...
    ProxyConfigLibrary(Context c){Context app=c.getApplicationContext();root=new File(app.getFilesDir(),"proxy/configs");prefs=app.getSharedPreferences("bichen",Context.MODE_PRIVATE);}
