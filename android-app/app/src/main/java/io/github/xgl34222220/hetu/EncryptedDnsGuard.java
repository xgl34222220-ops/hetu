...
final class EncryptedDnsGuard {
    ...
    EncryptedDnsGuard(Context context){
        ...
        prefs=this.context.getSharedPreferences("hetu",Context.MODE_PRIVATE);
    ...
    boolean update()throws Exception{
        ...
        c.setRequestProperty("Accept","text/plain");c.setRequestProperty("User-Agent","Hetu-EncryptedDnsGuard/1");
