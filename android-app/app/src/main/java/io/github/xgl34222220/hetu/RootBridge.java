...
public final class RootBridge {
    ...
    private static final String PRESENT = "__HETU_MODULE_PRESENT__";
    private static final String ABSENT = "__HETU_MODULE_ABSENT__";
    ...
    public static JSONObject status(Context context) {
        ...
        String command = "if [ \"$(id -u)\" != 0 ]; then "
                ...
                + "  printf '%s\\n' '" + ABSENT + "'\n"
                + "  if [ -d /data/adb/modules_update/hetu ]; then "
                ...
                + "[ ! -d /data/adb/modules_update/hetu ] || bc_pending=1\n"
    ...
    static Result rootShell(Context context, String command, long timeoutMs) {
        ...
        try {
            ...
            readerThread = new Thread(reader, "hetu-root-output");
