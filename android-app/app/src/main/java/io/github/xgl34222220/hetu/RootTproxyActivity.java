...
public final class RootTproxyActivity extends Activity {
    ...
    private void refresh(){
        ...
        appScopeValue.setText(scopeLabel(p.appScope));tcpValue.setText(on(p.tcp));udpValue.setText(on(p.udp));dnsValue.setText(dnsLabel(p.dnsHijack));quicValue.setText(on(p.quicBlocked));shareValue.setText(on(prefs.getBoolean("proxySharedNetwork",false)));killValue.setText(on(prefs.getBoolean("proxyKillSwitch",false)));bootValue.setText(on(prefs.getBoolean("proxyRootAutoStart",false)));
