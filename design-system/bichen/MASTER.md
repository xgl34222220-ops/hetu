# Bichen Design System — Master

> Scope: 辟尘 Android App / Jetpack Compose. This is the global visual source of truth. Page files under `pages/` may override it when the information density or interaction model is different.

## Product direction

Bichen is a privacy/network utility, not a showcase app. The visual direction combines:
...
Do not mechanically copy LuoShu. Keep the good parts of its spacing, motion and floating dock, but let Bichen use a calmer network/security-tool hierarchy.
