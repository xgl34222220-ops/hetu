...
- File manager is available for the Hetu proxy runtime directory.
...
- Only the loopback-local dashboard receives the controller secret automatically. Remote dashboard origins do not receive the secret from Hetu.
