...
def main():
    ...
    apk = folder / f'Bichen-{VERSION}.apk'
    module = folder / f'Bichen-{VERSION}-module.zip'
    ...
    with zipfile.ZipFile(apk) as z:
        if z.testzip() is not None or z.read('assets/bichen-module.zip') != module.read_bytes():
    ...
    for part in ("name='io.github.xgl34222220.bichen'", f"versionCode='{CODE}'", f"versionName='{VERSION}'"):
